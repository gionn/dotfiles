...
- Don't let a comment be a bare pointer — encode the substance, since links/specs/section numbers rot. A maintained doc at a stable path is fine, and system-level "why it's built this way" narrative belongs there as its own extraction, not inline. Tickets/Confluence/RFCs are fine as trailing breadcrumbs.
